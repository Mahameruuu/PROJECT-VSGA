                    ...
                    <div class="row">
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-transaksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="status" class="form-control" id="status" type="text" placeholder="ISBN 123-1234-12-1" required/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Keterangan</label>
                              <div class="col-sm-8">
                                  <input name="ket" class="form-control" id="ket" type="text" placeholder="ISBN 123-1234-12-1" required/>
                              </div>
                          </div>
                          <div class="form-group">
                          </div>
